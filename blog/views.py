...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        # this saves the form to the user who is logged in
        #overrides form valid method for Create View
...
# This test ensures this post is being updated by the author of the post
    def test_func(self):
...
class PostDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Post
    success_url = '/'  # this redirects the user to the home page after they have deleted their post
